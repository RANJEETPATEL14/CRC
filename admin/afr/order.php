...
<html lang="en">
        ...
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Profile <i class="ion-ios-arrow-forward"></i></span></p>
              ...
              <div class = "modal fade" id = "edit_order" tabindex = "-1" role = "dialog" aria-labelledby = "myModallabel">
    ...
    <br />
            <table id = "table" class = "table table-bordered">
              ...
              <th>Action</th>
					...
					<?php
          $i=1;
						$q_order = $conn->query("SELECT * FROM `orders`") or die(mysqli_error());
						while($f_order = $q_order->fetch_array()){
					?>	
						<tr>
							<td><?php echo $i;?></td>
							<td><?php echo $f_order['item']?>
              <td><?php echo $f_order['anysuggestion']?>
              <td><?php echo $f_order['date']?>
              <td><?php echo $f_order['status']?>
              <td> <a class = "btn btn-warning eorder_id" name = "<?php echo $f_order['order_id']?>" href = "#" data-toggle = "modal" data-target = "#edit_order"><span class = "glyphicon glyphicon-edit"></span>Change Order Status</a></td>
						</tr>
					<?php
          $i++;
						}
  ...
  <script type = "text/javascript">
		$(document).ready(function(){
			...
			$('.eorder_id').click(function(){
				$order_id = $(this).attr('name');
				$('#edit_query').load('../load_edit1.php?order_id=' + $order_id);
			});
		});
	</script>
  </body>
