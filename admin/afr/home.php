...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel js-fullheight">
		<div class="slider-item js-fullheight" style="background-image: url(../../user/images/bg_1.jpg);">
			<div class="overlay">
			</div>
		...
		<div class="slider-item js-fullheight" style="background-image: url(../../user/images/bg_2.jpg);">
			<div class="overlay">
			</div>
		...
		<div class="slider-item js-fullheight" style="background-image: url(../../user/images/bg_3.jpg);">
			<div class="overlay">
			</div>
