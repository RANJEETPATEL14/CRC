...
<html lang="en">
  ...
  <body>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class = " btn dropdown">
							...
							<ul class = "dropdown-menu">
								<li><a href = "afr/order.php">See Your Orders</a></li>
    ...
    <br />
    <br />
      <div class = "modal fade" id = "edit_customer" tabindex = "-1" role = "dialog" aria-labelledby = "myModallabel">
            ...
            <table id = "table" class = "table table-bordered">
					...
					<tbody>
					<?php
						$q_customer = $conn->query("SELECT * FROM `customer` WHERE `customer_id` = '$_SESSION[customer_id]'") or die(mysqli_error());
						while($f_customer = $q_customer->fetch_array()){
					?>	
						<tr>
							<td><?php echo $f_customer['username']?></td>
							<td><?php echo $f_customer['name']?>
							<td><?php echo $f_customer['mobilenumber']?></td>
                            <td><?php echo $f_customer['address']?></td>
							<td><?php echo $f_customer['password']?></td>
							<td> <a class = "btn btn-warning  ecustomer_id" name = "<?php echo $f_customer['customer_id']?>" href = "#" data-toggle = "modal" data-target = "#edit_customer">Change Details</a></td>
						</tr>
					<?php
						}
					?>
